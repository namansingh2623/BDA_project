...
wages_2019 = merged_df["2019 Median Wage"]
...
# Bars for 2019 and 2023 wages
ax.bar(x, wages_2019, width=bar_width, label="2019 Median Wage", color="skyblue")
...
ax.set_ylabel("Median Annual Wage ($)", fontsize=12)
ax.set_title("Comparison of Median Annual Wages (2019 vs 2023)", fontsize=14)
